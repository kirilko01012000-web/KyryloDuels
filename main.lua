...
if introShouldPlay then
    ...
    logo.Image = LOGO_ID
    logo.ImageColor3 = Color3.fromRGB(160,130,255)
    ...
    sub.TextColor3 = Color3.fromRGB(140,120,200)
   ...
   _TS:Create(loadingBar, TweenInfo.new(2, Enum.tasingStyle.Linear), {Size = UDim2.new(1,0,1,0)}):Play()
end)
task.wait(2.5)
pcall(function()
    ...
    _TS:Create(loadingBar, TweenInfo.new(0.8), {BackgroundTransparency = 1}):Play()
end)
task.wait(1)
pcall(function()
    introGui:Destroy()
...
-- ============================================================
local Presets = {}
local PRESET_FILE = "MemsDuelsPresets.json"
local LAST_PRESET_FILE = "MemsDuelsLastPreset.json"
...
-- ============================================================
-- COLORS (Фиолетово-синяя тема)
-- ============================================================
local C = {
    winBg=Color3.fromRGB(8,8,16), winBg2=Color3.fromRGB(12,12,24), winBorder=Color3.fromRGB(120,80,255),
    sidebarBg=Color3.fromRGB(8,8,16), sidebarDiv=Color3.fromRGB(60,40,120),
    topBg=Color3.fromRGB(6,6,14), topTitle=Color3.fromRGB(220,210,255), topSub=Color3.fromRGB(140,120,200),
    topBtn=Color3.fromRGB(100,70,200), topBtnHov=Color3.fromRGB(140,100,240), topDivider=Color3.fromRGB(60,40,120),
    tabBarBg=Color3.fromRGB(8,8,16), tabBarDiv=Color3.fromRGB(60,40,120),
    tabIdle=Color3.fromRGB(150,130,210), tabIdleHov=Color3.fromRGB(200,180,240),
    tabActive=Color3.fromRGB(220,210,255), tabActiveBg=Color3.fromRGB(16,12,30), tabUnderline=Color3.fromRGB(120,80,255),
    sectionTxt=Color3.fromRGB(160,130,255), sectionDiv=Color3.fromRGB(60,40,120),
    rowBg=Color3.fromRGB(8,8,16), rowBorder=Color3.fromRGB(50,35,100), rowLabel=Color3.fromRGB(210,200,245),
    rowSub=Color3.fromRGB(140,120,200), rowValue=Color3.fromRGB(200,180,240), rowHov=Color3.fromRGB(16,12,30),
    inputBg=Color3.fromRGB(10,10,20), inputBorder=Color3.fromRGB(70,50,150), inputFocus=Color3.fromRGB(120,80,255),
    inputTxt=Color3.fromRGB(220,210,255),
    pillOff=Color3.fromRGB(30,20,60), pillOn=Color3.fromRGB(120,80,255), dotOff=Color3.fromRGB(80,60,150),
    dotOn=Color3.fromRGB(12,10,24), pillBorder=Color3.fromRGB(70,50,150),
    modeBtnBg=Color3.fromRGB(10,10,20), modeBtnBrd=Color3.fromRGB(70,50,150), modeBtnTxt=Color3.fromRGB(160,130,255),
    modeBtnActBg=Color3.fromRGB(120,80,255), modeBtnActTx=Color3.fromRGB(12,10,24),
    chipBg=Color3.fromRGB(10,10,20), chipBorder=Color3.fromRGB(70,50,150), chipTxt=Color3.fromRGB(180,160,230),
    btnBg=Color3.fromRGB(10,12,22), btnBorder=Color3.fromRGB(70,50,150), btnTxt=Color3.fromRGB(200,180,240),
    btnHov=Color3.fromRGB(20,16,36),
    stackBg=Color3.fromRGB(8,8,18), stackBrd=Color3.fromRGB(70,50,150), stackTxt=Color3.fromRGB(160,130,255),
    stackActBg=Color3.fromRGB(40,25,90), stackActBrd=Color3.fromRGB(120,80,255), stackActTxt=Color3.fromRGB(220,210,255),
    stackDot=Color3.fromRGB(70,50,150), stackDotOn=Color3.fromRGB(140,100,255),
    infoBg=Color3.fromRGB(8,8,18), infoBrd=Color3.fromRGB(60,40,120), infoTxt=Color3.fromRGB(140,120,200),
    infoVal=Color3.fromRGB(200,180,240), infoFill=Color3.fromRGB(120,80,255),
    accent=Color3.fromRGB(120,80,255), accentDim=Color3.fromRGB(70,50,150),
    presetBg=Color3.fromRGB(10,10,20), presetBrd=Color3.fromRGB(70,50,150), presetLoad=Color3.fromRGB(120,80,255),
    presetDel=Color3.fromRGB(120,40,80), delBrd=Color3.fromRGB(180,60,100), lockOn=Color3.fromRGB(120,80,255),
    divider=Color3.fromRGB(60,40,120),
}
...
local function Main()
    ...
    gui.Name="MemsDuelsV2"; gui.ResetOnSpawn=false; gui.DisplayOrder=10
...
mainStroke.Thickness = 1.4; mainStroke.Color = Color3.fromRGB(120,80,255); mainStroke.Transparency = 0.2
    ...
    accentBar.BackgroundColor3 = Color3.fromRGB(120,80,255); accentBar.BackgroundTransparency = 0.85
    ...
    mkCorner(avatarBg,16); mkStroke(avatarBg, Color3.fromRGB(120,80,255), 1.5).Transparency = 0.25
    ...
    titleLbl.BackgroundTransparency = 1; titleLbl.Text = "Kyrylo Duels"
    ...
    local function makeInputRow(label, default, onChange)
        ...
        local rowStroke = mkStroke(row, Color3.fromRGB(70,50,150),1); rowStroke.Transparency = 0.5
        ...
        mkCorner(boxWrap,8); local bs = mkStroke(boxWrap, Color3.fromRGB(70,50,150),1); bs.Transparency=0.3
        ...
        box.Focused:Connect(function() TweenService:Create(bs,TweenInfo.new(0.15),{Color=Color3.fromRGB(120,80,255),Transparency=0}):Play() end)
        box.FocusLost:Connect(function()
            TweenService:Create(bs,TweenInfo.new(0.15),{Color=Color3.fromRGB(70,50,150),Transparency=0.3}):Play()
            if onChange then
    ...
    local function makeToggleRow(label, defaultOn, onToggle)
        ...
        pillBg.BackgroundColor3 = defaultOn and Color3.fromRGB(120,80,255) or Color3.fromRGB(30,36,32)
        ...
        local function setV(on)
            ...
            TweenService:Create(pillBg, TweenInfo.new(0.18, Enum.EasingStyle.Quint), {
                BackgroundColor3 = on and Color3.fromRGB(120,80,255) or Color3.fromRGB(30,36,32)
            }):Play()
...
toggleSetters["introEnabled"] = introSetter
            ...
            local fl = Instance.new("TextLabel", fw); fl.Size = UDim2.new(1,0,1,0); fl.BackgroundTransparency=1; fl.Text="Kyrylo Duels  ·  powered by luck"; fl.TextColor3=Color3.fromRGB(160,130,255); fl.Font=Enum.Font.Gotham; fl.TextSize=10; fl.TextXAlignment=Enum.TextXAlignment.Center
            ...
            _G._VezyFlashSave = function(success)
                ...
                if success then lbl.Text="✓  Auto-saved"; lbl.TextColor3=Color3.fromRGB(160,130,255)
                else lbl.Text="✗  Save failed"; lbl.TextColor3=Color3.fromRGB(220,80,80) end
                task.delay(1.5,function() if lbl and lbl.Parent then lbl.Text="Kyrylo Duels  ·  powered by luck"; lbl.TextColor3=Color3.fromRGB(160,130,255) end end)
            end
        end)
        page.LayoutOrder = 6
    end
    -- ============================================================
-- ALL KEYBINDS PAGE (ВСЕ КЕЙБИНДЫ В ОДНОМ МЕСТЕ - ВНИЗУ)
-- ============================================================
do
    local page = buildPage("ALL KEYBINDS", function()
        makeGap(2)
        makeSectionHeader("ALL KEYBINDS")
        makeGap(2)
        ...
        makeKeybindRow("Aim Bypass Key", Keys.aimBypass, function(k) Keys.aimBypass = k; requestSave() end, "aimBypass")
        makeKeybindRow("TP Bat Key", Keys.tpBat, function(k) Keys.tpBat = k; requestSave() end, "tpBat")
    ...
    page.LayoutOrder = 7  -- Последняя вкладка
end
...
infoBar.BackgroundColor3 = Color3.fromRGB(8,8,16); infoBar.BorderSizePixel=0; infoBar.Active=true
mkCorner(infoBar,18); mkStroke(infoBar, Color3.fromRGB(120,80,255), 1.5)
...
progressFill.Size = UDim2.new(0,0,1,0); progressFill.BackgroundColor3 = Color3.fromRGB(120,80,255)
    ...
    stealTextLbl.BackgroundTransparency=1; stealTextLbl.Text="STEAL"; stealTextLbl.TextColor3=Color3.fromRGB(180,160,255)
    ...
    stealPctLbl.BackgroundTransparency=1; stealPctLbl.Text="0%"; stealPctLbl.TextColor3=Color3.fromRGB(120,80,255)
    ...
    mkCorner(statusDotBg,11); mkStroke(statusDotBg, Color3.fromRGB(120,80,255),1)
    ...
    statusDot.BackgroundColor3 = Color3.fromRGB(120,80,255); statusDot.BorderSizePixel=0; mkCorner(statusDot,5)
    ...
    task.spawn(function()
        while task.wait(0.5) do
            pcall(function()
                ...
                if statusDot then statusDot.BackgroundColor3 = State.isStealing and Color3.fromRGB(160,130,255) or Color3.fromRGB(120,80,255) end
            end)
        end
    end)
    ...
    -- Если включаем Lagger (mode 1 или 2) - выключаем Carry Speed
    ...
    -- Обновляем отображение скорости в carryBox
    if carryBox then
    ...
    -- Если включаем Carry Speed
    if not State.speedToggled then
        -- Выключаем Lagger режимы
...
btnFrame.Size = UDim2.new(0, BTN_W * 1.1, 0, BTN_H * 1.1)
btnFrame.TextSize = 11 * 1.1
...
-- Для aimBypass добавляем в toggleSetters
if def.key == "aimBypass" then
    toggleSetters["aimBypass"] = function(on)
        setOn(on)
        if on then
            if State.batAimbotToggled then
...
-- NEW: Для tpBat добавляем в toggleSetters
if def.key == "tpBat" then
    toggleSetters["tpBat"] = function(on)
        setOn(on)
    end
end
    ...
    -- Если включаем Carry Speed (сейчас выключен)
    if not State.speedToggled then
        -- Выключаем Lagger режимы
        if State.laggerMode == 1 or State.laggerMode == 2 then
            State.laggerMode = 0
...
if def.key == "tpBat" then
    ...
    if State.tpBatEnabled then
        ...
        if State.aimBypassToggled then
            State.aimBypassToggled = false
            stopAimBypass()
            if stackBtnRefs.aimBypass then stackBtnRefs.aimBypass.setOn(false) end
        end
        -- Запускаем TP BAT
        startTpBat()
    else
...
if def.key == "autoLeft" then
    ...
    if ns then
        ...
        -- Выключаем Auto Bat если включен
        if State.batAimbotToggled then
            State.batAimbotToggled=false
            stopBatAimbot()
            if stackBtnRefs.aimbot then stackBtnRefs.aimbot.setOn(false) end
        end
        -- ВЫКЛЮЧАЕМ AIM BYPASS если включен
        if State.aimBypassToggled then
            State.aimBypassToggled=false
            stopAimBypass()
            if stackBtnRefs.aimBypass then stackBtnRefs.aimBypass.setOn(false) end
...
elseif def.key == "aimbot" then
    ...
    -- NEW: Функция для поиска ближайшего игрока для TP BAT
function getClosestPlayerForTp()
    local char = LP.Character
    ...
    Conns.aimbot = RunService.RenderStepped:Connect(function()
        ...
        -- Экипируем бату если нет в руках
        ...
        local chaseSpeed = State.aimbotSpeed or 58
        ...
        -- ============ УДАР (только если Auto Swing включен) ============
    ...
    -- ============================================================
-- ANTI-RAGDOLL (UNDETECTED VERSION из message.txt)
-- ============================================================
local antiRagCache = {}
...
local function isRagdolledAntiRag()
    local hum = antiRagCache.humanoid
...
local function removeRagdollConstraints()
    local char = antiRagCache.character
    if not char then return end
...
startAntiRagdoll = function()
    ...
    if not cacheCharacterAntiRag() then return end
    
    antiRagActive = true
    
    antiRagConn = RunService.RenderStepped:Connect(function()
        if not antiRagActive then return end
        if not antiRagCache.humanoid or not antiRagCache.humanoid.Parent then
            cacheCharacterAntiRag()
            return
        end
        
        if isRagdolledAntiRag() then
...
stopAntiRagdoll = function()
    ...
    local bb = head:FindFirstChild("MemsDuelsBB"); if not bb then return nil end  -- ✅ НОВОЕ ИМЯ
        ...
        task.spawn(function()
            ...
            while t >= 0.0 do
                ...
                if lbl then
                    ...
                    lbl.TextColor3 = Color3.fromRGB(160, 130, 255)
                end
                task.wait(0.1)
                t = math.round((t - 0.1) * 10) / 10
            end
            local lbl = getRagTimerLbl()
            if lbl then lbl.Text = "STEAL!"; lbl.TextColor3 = Color3.fromRGB(160, 130, 255) end
    ...
    if head then
        ...
        -- SPEED (фиолетовый)
        local speedBillLbl=Instance.new("TextLabel",bb); speedBillLbl.Name="SpeedBillLbl"; speedBillLbl.Size=UDim2.new(1,0,0,24); speedBillLbl.BackgroundTransparency=1; speedBillLbl.Text="0.0"; speedBillLbl.TextColor3=Color3.fromRGB(160,130,255); speedBillLbl.Font=Enum.Font.GothamBlack; speedBillLbl.TextScaled=true; speedBillLbl.TextStrokeTransparency=0.1; speedBillLbl.TextStrokeColor3=Color3.new(0,0,0); speedBillLbl.LayoutOrder=1
        
        -- DISCORD (фиолетовый)
        local discordLbl=Instance.new("TextLabel",bb); discordLbl.Size=UDim2.new(1,0,0,22); discordLbl.BackgroundTransparency=1; discordLbl.Text="discord.gg/kUesPDueMW"; discordLbl.TextColor3=Color3.fromRGB(160,130,255); discordLbl.Font=Enum.Font.GothamBold; discordLbl.TextScaled=true; discordLbl.TextStrokeTransparency=0.1; discordLbl.TextStrokeColor3=Color3.new(0,0,0); discordLbl.LayoutOrder=2
        
        -- RAGDOLL TIMER (красный, не меняем)
    ...
    if head2 then
        local bb2=head2:FindFirstChild("GreenDuelsBB")  -- ✅ ИЩЕТ GreenDuelsBB (как в setupChar)
    ...
    if State.autoLeftEnabled then
        ...
        if State.aimBypassToggled then State.aimBypassToggled=false; stopAimBypass(); if stackBtnRefs.aimBypass then stackBtnRefs.aimBypass.setOn(false) end end
        startAutoLeft()
...
elseif kc==Keys.autoRight then
    ...
    elseif kc==Keys.aimbot then
        ...
        requestSave()
    elseif kc==Keys.aimBypass then
        State.aimBypassToggled=not State.aimBypassToggled
        if State.aimBypassToggled then
            if State.batAimbotToggled then State.batAimbotToggled=false; stopBatAimbot(); if stackBtnRefs.aimbot then stackBtnRefs.aimbot.setOn(false) end end
            if State.autoLeftEnabled then State.autoLeftEnabled=false; stopAutoLeft(); if stackBtnRefs.autoLeft then stackBtnRefs.autoLeft.setOn(false) end end
            if State.autoRightEnabled then State.autoRightEnabled=false; stopAutoRight(); if stackBtnRefs.autoRight then stackBtnRefs.autoRight.setOn(false) end end
            pcall(startAimBypass)
        else stopAimBypass() end
        if stackBtnRefs.aimBypass then stackBtnRefs.aimBypass.setOn(State.aimBypassToggled) end
        requestSave()
        elseif kc==Keys.tpBat then
State.tpBatEnabled = not State.tpBatEnabled
if stackBtnRefs.tpBat then stackBtnRefs.tpBat.setOn(State.tpBatEnabled) end
if State.tpBatEnabled then
    -- Выключаем другие режимы
    if State.autoLeftEnabled then
        State.autoLeftEnabled = false
...
requestSave()
    ...
    cloverBtn.Name = "MemsDuelsClover"
    cloverBtn.Size = UDim2.new(0,140,0,36)
    cloverBtn.Position = UDim2.new(0,20,0,200)
    cloverBtn.BackgroundColor3 = Color3.fromRGB(14,12,28)
    cloverBtn.BorderSizePixel = 0
    cloverBtn.Text = "Kyrylo Duels"
    cloverBtn.TextColor3 = Color3.fromRGB(160,130,255)
    cloverBtn.Font = Enum.Font.GothamBold
    cloverBtn.TextSize = 14
    cloverBtn.ZIndex = 25
    cloverBtn.Visible = true
    mkCorner(cloverBtn,12)
    mkStroke(cloverBtn, Color3.fromRGB(120,80,255), 1.5)
    ...
    saveConfig = function()
        ...
        pcall(function()
            ...
            local cfg = {
                ...
                aimBypassKey = Keys.aimBypass and Keys.aimBypass.Name or "V",
                ...
                aimBypass = State.aimBypassToggled,
        ...
        if not success then
            ...
            warn("[Kyrylo Duels] Config save FAILED!")
        else
    ...
    loadConfig = function()
        ...
        if not raw or raw == "" then
            if _isfile(CONFIG_BACKUP) then
                ...
                if raw and raw ~= "" then
                    print("[Kyrylo Duels] Loaded config from backup")
                end
            end
        end
        if not raw or raw == "" then
            print("[Kyrylo Duels] No valid config file found, using defaults")
            return false
        end
        ...
        State.aimbotSpeed = applyNumber("aimbotSpeed", State.aimbotSpeed, aimbotSpeedBox)
...
if decErr.autoTPEnabled ~= nil then State.autoTPEnabled = decErr.autoTPEnabled end
        ...
        local keyMap = {
            ...
            aimBypassKey="aimBypass", tpBatKey="tpBat"
        }
        ...
        -- Обновляем отображение carryBox в зависимости от режима
if carryBox then
    if State.laggerMode == 1 then
        carryBox.Text = tostring(State.laggerSpeed)
    elseif State.laggerMode == 2 then
...
if stackBtnRefs.laggerCarry then stackBtnRefs.laggerCarry.setOn(State.laggerMode == 2) end
        ...
        for key, setter in pairs(toggleSetters) do
            ...
            elseif key=="aimBypass" then stateValue=State.aimBypassToggled
            end
        ...
        print("[Kyrylo Duels] Config loaded successfully")
        return true
    end
    ...
    startAutoSteal()
    -- ============================================================
-- AIMBYPASS (FIXED BYPASS СТИЛЬ - вращение через AssemblyAngularVelocity)
-- ============================================================
local VYSE_HIT_DIST = 8
local SWING_COOLDOWN_AIMBYPASS = 0.35
local CHASE_SPEED_AIMBYPASS = 58
...
-- Поиск бата
local function findBatForAimBypass()
    local char = LP.Character
...
-- Удар
local aimHitCD = false
local function tryHitBatAimBypass()
    if aimHitCD then return end
    aimHitCD = true
    
    pcall(function()
        local char = LP.Character
        if char then
            local bat = findBatForAimBypass()
            if bat then
                if bat.Parent ~= char then
                    local hum = char:FindFirstChildOfClass("Humanoid")
    ...
    task.delay(SWING_COOLDOWN_AIMBYPASS, function() 
        aimHitCD = false 
    end)
end

local aimBypassConn = nil
local prevAutoRotateAim = nil

-- СТАРТ AIM BYPASS (улучшенный имбовый + пробивает антибат)
startAimBypass = function()
    if aimBypassConn then 
        aimBypassConn:Disconnect() 
    end
    
    local hum = LP.Character and LP.Character:FindFirstChildOfClass("Humanoid")
    if hum then
        if prevAutoRotateAim == nil then 
            prevAutoRotateAim = hum.AutoRotate 
        end
        hum.AutoRotate = false
    end
    
    aimBypassConn = RunService.RenderStepped:Connect(function()
        ...
        local target, targetDist = getClosestPlayerAim()
        if not target then return end
        ...
        local chaseSpeed = 58
        local desiredHeight = targetPos.Y + 1.5
        local yVel = (desiredHeight - myPos.Y) * 19.5
        if hum.FloorMaterial ~= Enum.Material.Air then 
            yVel = math.max(yVel, 10) 
        end
        yVel = math.clamp(yVel, -70, 110)
        ...
        -- ============ ПРИЦЕЛ (СНИЗУ + МИКРО-БОК ДЛЯ АНТИБАТА) ============
        local toTargetDir = (targetPos - myPos).Unit
        local rightVec = Vector3.new(-toTargetDir.Z, 0, toTargetDir.X).Unit
        
        -- 👈 ГЛАВНОЕ: бьём НЕ В ЦЕНТР, а СБОКУ-СНИЗУ (антибат не блокирует)
        local aimPoint = targetPos 
            + rightVec * 2.5              -- 👈 бок (антибат не достаёт)
            + Vector3.new(0, -3.5, 0)     -- 👈 снизу (антибат не блокирует)
            + toTargetDir * 0.5           -- 👈 чуть вперёд
        
        -- 👈 Если противник стоит на месте - бьём ещё хитрее
        if tr.AssemblyLinearVelocity.Magnitude < 1.5 then
            aimPoint = targetPos 
                + rightVec * 3.5          -- 👈 сильнее вбок
                + Vector3.new(0, -4.5, 0) -- 👈 сильнее вниз
                + toTargetDir * 0.3
        end
        
        -- 👈 Если противник прыгает - бьём выше
        if tr.AssemblyLinearVelocity.Y > 3 then
            aimPoint = targetPos 
                + rightVec * 2.0
                + Vector3.new(0, -1.0, 0) -- 👈 меньше вниз
                + toTargetDir * 0.5
        end
        
        -- ============ КРУЧЕНИЕ (КАК БЫЛО - БЫСТРОЕ) ============
        local toAimPoint = aimPoint - myPos
        if toAimPoint.Magnitude > 0.1 then
            local goalCF = CFrame.lookAt(myPos, aimPoint)
            local diffCF = root.CFrame:Inverse() * goalCF
            local rx, ry, rz = diffCF:ToEulerAnglesXYZ()
            
            -- 👈 БЫСТРОЕ КРУЧЕНИЕ (как было)
            local TILT_SPEED = 45
            rx = math.clamp(rx, -2.5, 2.5)
            ry = math.clamp(ry, -2.5, 2.5)
            rz = math.clamp(rz, -2.5, 2.5)
            ...
            root.AssemblyAngularVelocity = root.CFrame:VectorToWorldSpace(
                Vector3.new(rx * TILT_SPEED, ry * TILT_SPEED, rz * TILT_SPEED)
            )
        end
        
        -- ============ УДАР (ПРОБИВАЕТ АНТИБАТ) ============
        local HIT_DISTANCE = 12
        
        if targetDist <= HIT_DISTANCE then
            -- 👈 ПЕРВЫЙ УДАР
            tryHitBatAimBypass()
            
            -- 👈 ВТОРОЙ УДАР (через 0.07 сек - если первый заблокировали)
            task.defer(function()
                if State.aimBypassToggled then
                    task.wait(0.07)
                    tryHitBatAimBypass()
            ...
            -- 👈 ТРЕТИЙ УДАР (если противник с антибатом)
...
stopAimBypass = function()
    ...
    if hum2 then
        hum2.AutoRotate = (prevAutoRotateAim == nil) and true or prevAutoRotateAim
...
function startTpBat()
    ...
    -- Отключаем авто-поворот как в AimBypass
    local hum0 = LP.Character and LP.Character:FindFirstChildOfClass("Humanoid")
    if hum0 then hum0.AutoRotate = false end
    ...
    tpBatConn = RunService.Heartbeat:Connect(function()
        ...
        if target and target.Character then
            ...
            if tr then
                ...
                -- Телепортируемся к цели (как в Mwvane)
                if sethiddenproperty then
                    sethiddenproperty(root, "PhysicsRepRootPart", tr)
                end
                
                local targetPos2 = tr.Position + Vector3.new(0, 0.9, 0)
                if (root.Position - targetPos2).Magnitude > 8 then
                    root.CFrame = CFrame.new(targetPos2)
                end
...
local function setupOtherPlayerSpeed(player)
    ...
    local function onCharacterAdded(char)
        ...
        local oldBB = head:FindFirstChild("MemsDuelsBB_Other")
        if oldBB then oldBB:Destroy() end
        local bb = Instance.new("BillboardGui", head)
        bb.Name = "MemsDuelsBB_Other"
        ...
        speedLbl.Text = "0.0"
        speedLbl.TextColor3 = Color3.fromRGB(160, 130, 255)
